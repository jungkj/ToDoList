...
//  ToDoList
//
//  Created by Andy Jung on 3/12/23.
//
...
class ToDosViewModel: ObservableObject{
    ...
    func toggleCompleted(toDo: ToDo){
        // Don't try to update if toDos.id == nil, which it never should be. But in case another develoepr tries to call this in the wrong place, we're covered...
